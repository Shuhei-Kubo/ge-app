...
5. いいな、役にたったなという投稿にはハートボタンをクリックすることで「いいね」することができます。

6. 投稿の中にあるチェックボタン（仮ボタンです）をクリックすることで日本語の投稿は英語に、英語の投稿は日本語に翻訳され語学初心者の方でも気軽に利用することができます。
![翻訳画面](https://i.gyazo.com/31eefd816b6e9f6048b8fd64afbdb59c.gif)
